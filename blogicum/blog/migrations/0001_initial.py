# Generated by Django 5.1.1 on 2025-11-07 19:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='blog.location', verbose_name='Местоположение')),
            ],
            options={
